...
export class Class {
    ...
    add_constructor(name: string | null, callback: GObject.Callback, return_type: GObject.Type, parameter_types?: GObject.Type[] | null[] | null): Value
    add_method_variadic(name: string, callback: GObject.Callback, return_type: GObject.Type): void
    add_method(name: string, callback: GObject.Callback, return_type: GObject.Type, parameter_types?: GObject.Type[] | null[] | null): void
...
export class Value {
    ...
    static new_function(context: Context, name: string | null, callback: GObject.Callback, return_type: GObject.Type, parameter_types?: GObject.Type[] | null[] | null): Value
