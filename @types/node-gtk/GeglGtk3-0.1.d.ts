...
export class View {
    ...
    on(sigName: "draw-background", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "draw-background", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "draw-background", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    on(sigName: "draw-overlay", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "draw-overlay", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "draw-overlay", callback: (...args: any[]) => void): NodeJS.EventEmitter
