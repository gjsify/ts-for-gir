...
export const WARN_USE_NAMESPACE_ON_TYPES = "useNamespace must be 'true' if buildType is 'types'"
export const WARN_USE_NAMESPACE_ON_ESM = "useNamespace must be 'true' on moduleType 'esm'"
export const WARN_USE_ESM_FOR_AMBIENT = "moduleType must be 'esm' if generateAmbient is true!"
export const WARN_USE_GJS_FOR_AMBIENT = "environments must include 'gjs' if generateAmbient is true!"
