...
const examples: ReadonlyArray<[string, string?]> = [
  [
    `${APP_NAME} json`,
    `Run '${APP_NAME} json' in your gjs project to generate JSON files for your project`,
  ],
  ...
  [
    `${APP_NAME} json --ignore=Gtk-4.0 xrandr-1.3`,
    "Generate JSON files but not for Gtk-4.0 and xrandr-1.3",
  ],
];
