...
export class WebsocketConnection {
    ...
    get_uri(): URI
    send_binary(data: Gjs.byteArray.ByteArray | null): void
    send_message(type: WebsocketDataType, message: Gjs.byteArray.ByteArray): void
...
export class WebsocketExtension {
    ...
    process_incoming_message(header: number, payload: Gjs.byteArray.ByteArray): Gjs.byteArray.ByteArray
    process_outgoing_message(header: number, payload: Gjs.byteArray.ByteArray): Gjs.byteArray.ByteArray
    /* Methods of GObject.Object */
    bind_property(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags): GObject.Binding
    bind_property_full(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, transform_to: GObject.Closure, transform_from: GObject.Closure): GObject.Binding
    force_floating(): void
    ...
    vfunc_process_incoming_message?(header: number, payload: Gjs.byteArray.ByteArray): Gjs.byteArray.ByteArray
    vfunc_process_outgoing_message?(header: number, payload: Gjs.byteArray.ByteArray): Gjs.byteArray.ByteArray
    /* Virtual methods of GObject.Object */
    vfunc_constructed?(): void
    vfunc_dispatch_properties_changed?(n_pspecs: number, pspecs: GObject.ParamSpec): void
    vfunc_dispose?(): void
