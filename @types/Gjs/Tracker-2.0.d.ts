...
export class SparqlConnection {
    ...
    update_array_finish(_res_: Gio.AsyncResult): any[]
    ...
    statistics(cancellable?: Gio.Cancellable | null): any
    statistics_async(cancellable?: Gio.Cancellable | null, _callback_?: Gio.AsyncReadyCallback | null): void
    statistics_finish(_res_: Gio.AsyncResult): any
    get_namespace_manager(): NamespaceManager | null
    query_statement(sparql: string, cancellable?: Gio.Cancellable | null): any
    /* Methods of GObject.Object */
    bind_property(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags): GObject.Binding
    bind_property_full(source_property: string, target: GObject.Object, target_property: string, flags: GObject.BindingFlags, transform_to: GObject.Closure, transform_from: GObject.Closure): GObject.Binding
    force_floating(): void
    ...
    vfunc_update_array_finish(_res_: Gio.AsyncResult): any[]
    ...
    vfunc_statistics(cancellable?: Gio.Cancellable | null): any
    vfunc_statistics_async(cancellable?: Gio.Cancellable | null, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_statistics_finish(_res_: Gio.AsyncResult): any
    vfunc_get_namespace_manager(): NamespaceManager | null
    vfunc_query_statement(sparql: string, cancellable?: Gio.Cancellable | null): any
    /* Virtual methods of GObject.Object */
    vfunc_constructed(): void
    vfunc_dispatch_properties_changed(n_pspecs: number, pspecs: GObject.ParamSpec): void
    vfunc_dispose(): void
