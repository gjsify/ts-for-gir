...
export class RemoteRegistry {
    ...
    registerDataSource(uniqueId: string, name: string, description: string, eventTemplates: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    ...
    vfuncRegisterDataSource(uniqueId: string, name: string, description: string, eventTemplates: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
...
export class RemoteLog {
    ...
    deleteEvents(eventIds: number[], cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    deleteEventsFinish(res: Gio.AsyncResult): GLib.Variant
    findEventIds(timeRange: GLib.Variant, eventTemplates: GLib.Variant, storageState: number, numEvents: number, resultType: number, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    findEventIdsFinish(res: Gio.AsyncResult): number[]
    findEvents(timeRange: GLib.Variant, eventTemplates: GLib.Variant, storageState: number, numEvents: number, resultType: number, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    findEventsFinish(res: Gio.AsyncResult): GLib.Variant
    findRelatedUris(timeRange: GLib.Variant, eventTemplates: GLib.Variant, resultEventTemplates: GLib.Variant, storageState: number, numEvents: number, resultType: number, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    findRelatedUrisFinish(res: Gio.AsyncResult): string[]
    getEvents(eventIds: number[], cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    getEventsFinish(res: Gio.AsyncResult): GLib.Variant
    insertEvents(events: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    insertEventsFinish(res: Gio.AsyncResult): number[]
    installMonitor(monitorPath: any, timeRange: GLib.Variant, eventTemplates: GLib.Variant, owner?: any, callback?: Gio.AsyncReadyCallback | null): void
    installMonitorFinish(res: Gio.AsyncResult): void
    removeMonitor(monitorPath: any, owner?: any, callback?: Gio.AsyncReadyCallback | null): void
    ...
    vfuncDeleteEvents(eventIds: number[], cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    vfuncDeleteEventsFinish(res: Gio.AsyncResult): GLib.Variant
    vfuncFindEventIds(timeRange: GLib.Variant, eventTemplates: GLib.Variant, storageState: number, numEvents: number, resultType: number, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    vfuncFindEventIdsFinish(res: Gio.AsyncResult): number[]
    vfuncFindEvents(timeRange: GLib.Variant, eventTemplates: GLib.Variant, storageState: number, numEvents: number, resultType: number, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    vfuncFindEventsFinish(res: Gio.AsyncResult): GLib.Variant
    vfuncFindRelatedUris(timeRange: GLib.Variant, eventTemplates: GLib.Variant, resultEventTemplates: GLib.Variant, storageState: number, numEvents: number, resultType: number, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    vfuncFindRelatedUrisFinish(res: Gio.AsyncResult): string[]
    vfuncGetEvents(eventIds: number[], cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    vfuncGetEventsFinish(res: Gio.AsyncResult): GLib.Variant
    vfuncInsertEvents(events: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, callback?: Gio.AsyncReadyCallback | null): void
    vfuncInsertEventsFinish(res: Gio.AsyncResult): number[]
    vfuncInstallMonitor(monitorPath: any, timeRange: GLib.Variant, eventTemplates: GLib.Variant, owner?: any, callback?: Gio.AsyncReadyCallback | null): void
    vfuncInstallMonitorFinish(res: Gio.AsyncResult): void
    vfuncRemoveMonitor(monitorPath: any, owner?: any, callback?: Gio.AsyncReadyCallback | null): void
