...
export function deviceCheckFirmware(device: GUsb.Device, data: any): boolean
...
export function deviceModeFromFirmware(data: any): DeviceMode
...
export class DeviceQueue {
    ...
    eraseFlash(device: GUsb.Device, address: number[]): void
    ...
    readFirmware(device: GUsb.Device, data: any): void
    readFlash(device: GUsb.Device, address: number, data: any): void
    readSram(device: GUsb.Device, address: number, data: any): void
    ...
    verifyFirmware(device: GUsb.Device, data: any): void
    verifyFlash(device: GUsb.Device, address: number, data: any): void
    writeEeprom(device: GUsb.Device, magic: string): void
    writeFirmware(device: GUsb.Device, data: any): void
    writeFlash(device: GUsb.Device, address: number, data: any): void
    writeSram(device: GUsb.Device, address: number, data: any): void
