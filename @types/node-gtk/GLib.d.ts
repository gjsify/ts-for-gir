...
export function asciiDtostr(buffer: string, buf_len: number, d: number): string
export function asciiFormatd(buffer: string, buf_len: number, format: string, d: number): string
export function asciiStrcasecmp(s1: string, s2: string): number
export function asciiStrdown(str: string, len: number): string
export function asciiStringToSigned(str: string, base: number, min: number, max: number): [ /* returnType */ boolean, /* out_num */ number | null ]
export function asciiStringToUnsigned(str: string, base: number, min: number, max: number): [ /* returnType */ boolean, /* out_num */ number | null ]
...
export function assertWarning(log_domain: string, file: string, line: number, pretty_function: string, expression: string): void
...
export function assertionMessageError(domain: string, file: string, line: number, func: string, expr: string, error: Error, error_domain: Quark, error_code: number): void
...
export function atomicRcBoxAcquire(mem_block: object): object
export function atomicRcBoxAlloc(block_size: number): object
export function atomicRcBoxAlloc0(block_size: number): object
export function atomicRcBoxDup(block_size: number, mem_block: object): object
export function atomicRcBoxGetSize(mem_block: object): number
export function atomicRcBoxRelease(mem_block: object): void
export function atomicRcBoxReleaseFull(mem_block: object, clear_func: DestroyNotify): void
...
export function base64EncodeClose(break_lines: boolean, state: number, save: number): [ /* returnType */ number, /* out */ any ]
export function base64EncodeStep(in_: any, break_lines: boolean, state: number, save: number): [ /* returnType */ number, /* out */ any ]
export function basename(file_name: string): string
export function bitLock(address: number, lock_bit: number): void
export function bitNthLsf(mask: number, nth_bit: number): number
export function bitNthMsf(mask: number, nth_bit: number): number
export function bitStorage(number: number): number
export function bitTrylock(address: number, lock_bit: number): boolean
export function bitUnlock(address: number, lock_bit: number): void
...
export function byteArrayFree(array: any, free_segment: boolean): number
...
export function canonicalizeFilename(filename: string, relative_to?: string | null): string
export function chdir(path: string): number
export function checkVersion(required_major: number, required_minor: number, required_micro: number): string
export function checksumTypeGetLength(checksum_type: ChecksumType): number
...
export function computeChecksumForBytes(checksum_type: ChecksumType, data: Bytes): string
export function computeChecksumForData(checksum_type: ChecksumType, data: any): string
export function computeChecksumForString(checksum_type: ChecksumType, str: string, length: number): string
export function computeHmacForBytes(digest_type: ChecksumType, key: Bytes, data: Bytes): string
export function computeHmacForData(digest_type: ChecksumType, key: any, data: any): string
export function computeHmacForString(digest_type: ChecksumType, key: any, str: string, length: number): string
export function convert(str: any, to_codeset: string, from_codeset: string): [ /* returnType */ any, /* bytes_read */ number | null ]
export function convertErrorQuark(): Quark
export function convertWithFallback(str: any, to_codeset: string, from_codeset: string, fallback: string): [ /* returnType */ any, /* bytes_read */ number | null ]
...
export function datalistIdGetData(datalist: Data, key_id: Quark): object | null
...
export function datasetDestroy(dataset_location: object): void
export function datasetForeach(dataset_location: object, func: DataForeachFunc): void
export function datasetIdGetData(dataset_location: object, key_id: Quark): object | null
...
export function dateValidJulian(julian_date: number): boolean
...
export function fileErrorFromErrno(err_no: number): FileError
export function fileErrorQuark(): Quark
export function fileGetContents(filename: string): [ /* returnType */ boolean, /* contents */ any ]
export function fileOpenTmp(tmpl?: string | null): [ /* returnType */ number, /* name_used */ string ]
...
export function filenameFromUtf8(utf8string: string, len: number): [ /* returnType */ string, /* bytes_read */ number | null, /* bytes_written */ number | null ]
export function filenameToUri(filename: string, hostname?: string | null): string
export function filenameToUtf8(opsysstring: string, len: number): [ /* returnType */ string, /* bytes_read */ number | null, /* bytes_written */ number | null ]
...
export function getFilenameCharsets(): [ /* returnType */ boolean, /* filename_charsets */ string[] ]
export function getHomeDir(): string
export function getHostName(): string
export function getLanguageNames(): string[]
export function getLanguageNamesWithCategory(category_name: string): string[]
...
export function hashTableAdd(hash_table: HashTable, key?: object | null): boolean
export function hashTableContains(hash_table: HashTable, key?: object | null): boolean
export function hashTableDestroy(hash_table: HashTable): void
export function hashTableInsert(hash_table: HashTable, key?: object | null, value?: object | null): boolean
export function hashTableLookup(hash_table: HashTable, key?: object | null): object | null
export function hashTableLookupExtended(hash_table: HashTable, lookup_key?: object | null): [ /* returnType */ boolean, /* orig_key */ object | null, /* value */ object | null ]
export function hashTableRemove(hash_table: HashTable, key?: object | null): boolean
export function hashTableRemoveAll(hash_table: HashTable): void
export function hashTableReplace(hash_table: HashTable, key?: object | null, value?: object | null): boolean
export function hashTableSize(hash_table: HashTable): number
export function hashTableSteal(hash_table: HashTable, key?: object | null): boolean
export function hashTableStealAll(hash_table: HashTable): void
export function hashTableStealExtended(hash_table: HashTable, lookup_key?: object | null): [ /* returnType */ boolean, /* stolen_key */ object | null, /* stolen_value */ object | null ]
export function hashTableUnref(hash_table: HashTable): void
export function hookDestroy(hook_list: HookList, hook_id: number): boolean
export function hookDestroyLink(hook_list: HookList, hook: Hook): void
export function hookFree(hook_list: HookList, hook: Hook): void
export function hookInsertBefore(hook_list: HookList, sibling: Hook | null, hook: Hook): void
export function hookPrepend(hook_list: HookList, hook: Hook): void
export function hookUnref(hook_list: HookList, hook: Hook): void
...
export function localeFromUtf8(utf8string: string, len: number): [ /* returnType */ any, /* bytes_read */ number | null ]
export function localeToUtf8(opsysstring: any): [ /* returnType */ string, /* bytes_read */ number | null, /* bytes_written */ number | null ]
export function logDefaultHandler(log_domain: string | null, log_level: LogLevelFlags, message?: string | null, unused_data?: object | null): void
export function logRemoveHandler(log_domain: string, handler_id: number): void
export function logSetAlwaysFatal(fatal_mask: LogLevelFlags): LogLevelFlags
export function logSetFatalMask(log_domain: string, fatal_mask: LogLevelFlags): LogLevelFlags
export function logSetHandler(log_domain: string | null, log_levels: LogLevelFlags, log_func: LogFunc): number
export function logSetWriterFunc(): void
export function logStructuredArray(log_level: LogLevelFlags, fields: LogField[]): void
export function logVariant(log_domain: string | null, log_level: LogLevelFlags, fields: Variant): void
export function logWriterDefault(log_level: LogLevelFlags, fields: LogField[], user_data?: object | null): LogWriterOutput
export function logWriterFormatFields(log_level: LogLevelFlags, fields: LogField[], use_color: boolean): string
export function logWriterIsJournald(output_fd: number): boolean
export function logWriterJournald(log_level: LogLevelFlags, fields: LogField[], user_data?: object | null): LogWriterOutput
export function logWriterStandardStreams(log_level: LogLevelFlags, fields: LogField[], user_data?: object | null): LogWriterOutput
export function logWriterSupportsColor(output_fd: number): boolean
...
export function malloc0N(n_blocks: number, n_block_bytes: number): object | null
export function mallocN(n_blocks: number, n_block_bytes: number): object | null
...
export function nullifyPointer(nullify_location: object): void
export function numberParserErrorQuark(): Quark
export function onErrorQuery(prg_name: string): void
export function onErrorStackTrace(prg_name: string): void
...
export function pathGetBasename(file_name: string): string
export function pathGetDirname(file_name: string): string
export function pathIsAbsolute(file_name: string): boolean
export function pathSkipRoot(file_name: string): string | null
export function patternMatch(pspec: PatternSpec, string_length: number, string: string, string_reversed?: string | null): boolean
...
export function pointerBitLock(address: object, lock_bit: number): void
export function pointerBitTrylock(address: object, lock_bit: number): boolean
export function pointerBitUnlock(address: object, lock_bit: number): void
...
export function rcBoxAcquire(mem_block: object): object
export function rcBoxAlloc(block_size: number): object
export function rcBoxAlloc0(block_size: number): object
export function rcBoxDup(block_size: number, mem_block: object): object
export function rcBoxGetSize(mem_block: object): number
export function rcBoxRelease(mem_block: object): void
export function rcBoxReleaseFull(mem_block: object, clear_func: DestroyNotify): void
export function realloc(mem: object | null, n_bytes: number): object | null
export function reallocN(mem: object | null, n_blocks: number, n_block_bytes: number): object | null
...
export function regexCheckReplacement(replacement: string): [ /* returnType */ boolean, /* has_references */ boolean | null ]
...
export function regexMatchSimple(pattern: string, string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): boolean
export function regexSplitSimple(pattern: string, string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): string[]
...
export function setApplicationName(application_name: string): void
...
export function shellParseArgv(command_line: string): [ /* returnType */ boolean, /* argvp */ string[] | null ]
export function shellQuote(unquoted_string: string): string
export function shellUnquote(quoted_string: string): string
export function sliceAlloc(block_size: number): object | null
export function sliceAlloc0(block_size: number): object | null
export function sliceCopy(block_size: number, mem_block?: object | null): object | null
export function sliceFree1(block_size: number, mem_block?: object | null): void
export function sliceFreeChainWithOffset(block_size: number, mem_chain: object | null, next_offset: number): void
export function sliceGetConfig(ckey: SliceConfig): number
export function sliceGetConfigState(ckey: SliceConfig, address: number, n_values: number): number
export function sliceSetConfig(ckey: SliceConfig, value: number): void
export function sourceRemove(tag: number): boolean
export function sourceRemoveByFuncsUserData(funcs: SourceFuncs, user_data?: object | null): boolean
export function sourceRemoveByUserData(user_data?: object | null): boolean
export function sourceSetNameById(tag: number, name: string): void
export function spacedPrimesClosest(num: number): number
export function spawnAsync(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup?: SpawnChildSetupFunc | null): [ /* returnType */ boolean, /* child_pid */ Pid | null ]
export function spawnAsyncWithFds(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | null, stdin_fd: number, stdout_fd: number, stderr_fd: number): [ /* returnType */ boolean, /* child_pid */ Pid | null ]
export function spawnAsyncWithPipes(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup?: SpawnChildSetupFunc | null): [ /* returnType */ boolean, /* child_pid */ Pid | null, /* standard_input */ number | null, /* standard_output */ number | null, /* standard_error */ number | null ]
export function spawnCheckExitStatus(exit_status: number): boolean
export function spawnClosePid(pid: Pid): void
export function spawnCommandLineAsync(command_line: string): boolean
export function spawnCommandLineSync(command_line: string): [ /* returnType */ boolean, /* standard_output */ any | null, /* standard_error */ any | null, /* exit_status */ number | null ]
export function spawnErrorQuark(): Quark
export function spawnExitErrorQuark(): Quark
export function spawnSync(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup?: SpawnChildSetupFunc | null): [ /* returnType */ boolean, /* standard_output */ any | null, /* standard_error */ any | null, /* exit_status */ number | null ]
...
export function strMatchString(search_term: string, potential_hit: string, accept_alternates: boolean): boolean
export function strToAscii(str: string, from_locale?: string | null): string
export function strTokenizeAndFold(string: string, translit_locale?: string | null): [ /* returnType */ string[], /* ascii_alternates */ string[] ]
...
export function stringSizedNew(dfl_size: number): String
...
export function strrstrLen(haystack: string, haystack_len: number, needle: string): string
export function strsignal(signum: number): string
export function strstrLen(haystack: string, haystack_len: number, needle: string): string
...
export function strvLength(str_array: string): number
export function testAddDataFunc(testpath: string, test_data: object | null, test_func: TestDataFunc): void
export function testAddDataFuncFull(testpath: string, test_data: object | null, test_func: TestDataFunc): void
export function testAddFunc(testpath: string, test_func: TestFunc): void
export function testAssertExpectedMessagesInternal(domain: string, file: string, line: number, func: string): void
export function testBug(bug_uri_snippet: string): void
export function testBugBase(uri_pattern: string): void
export function testExpectMessage(log_domain: string | null, log_level: LogLevelFlags, pattern: string): void
export function testFail(): void
export function testFailed(): boolean
export function testGetDir(file_type: TestFileType): string
export function testIncomplete(msg?: string | null): void
export function testLogTypeName(log_type: TestLogType): string
export function testQueueDestroy(destroy_func: DestroyNotify, destroy_data?: object | null): void
export function testQueueFree(gfree_pointer?: object | null): void
export function testRandDouble(): number
export function testRandDoubleRange(range_start: number, range_end: number): number
...
export function testTrapAssertions(domain: string, file: string, line: number, func: string, assertion_flags: number, pattern: string): void
export function testTrapFork(usec_timeout: number, test_trap_flags: TestTrapFlags): boolean
export function testTrapHasPassed(): boolean
export function testTrapReachedTimeout(): boolean
export function testTrapSubprocess(test_path: string | null, usec_timeout: number, test_flags: TestSubprocessFlags): void
...
export function threadPoolSetMaxUnusedThreads(max_threads: number): void
export function threadPoolStopUnusedThreads(): void
export function threadSelf(): Thread
export function threadYield(): void
export function timeValFromIso8601(iso_date: string): [ /* returnType */ boolean, /* time_ */ TimeVal ]
...
export function trashStackHeight(stack_p: TrashStack): number
export function trashStackPeek(stack_p: TrashStack): object | null
export function trashStackPop(stack_p: TrashStack): object | null
export function trashStackPush(stack_p: TrashStack, data_p: object): void
export function tryMalloc(n_bytes: number): object | null
export function tryMalloc0(n_bytes: number): object | null
export function tryMalloc0N(n_blocks: number, n_block_bytes: number): object | null
export function tryMallocN(n_blocks: number, n_block_bytes: number): object | null
export function tryRealloc(mem: object | null, n_bytes: number): object | null
export function tryReallocN(mem: object | null, n_blocks: number, n_block_bytes: number): object | null
export function ucs4ToUtf16(str: number, len: number): [ /* returnType */ number, /* items_read */ number | null, /* items_written */ number | null ]
export function ucs4ToUtf8(str: number, len: number): [ /* returnType */ string, /* items_read */ number | null, /* items_written */ number | null ]
...
export function unicharFullyDecompose(ch: number, compat: boolean, result_len: number): [ /* returnType */ number, /* result */ number | null ]
export function unicharGetMirrorChar(ch: number, mirrored_ch: number): boolean
...
export function unicodeCanonicalDecomposition(ch: number, result_len: number): number
...
export function uriEscapeString(unescaped: string, reserved_chars_allowed: string | null, allow_utf8: boolean): string
export function uriListExtractUris(uri_list: string): string[]
export function uriParseScheme(uri: string): string
export function uriUnescapeSegment(escaped_string?: string | null, escaped_string_end?: string | null, illegal_characters?: string | null): string
export function uriUnescapeString(escaped_string: string, illegal_characters?: string | null): string
export function usleep(microseconds: number): void
export function utf16ToUcs4(str: number, len: number): [ /* returnType */ number, /* items_read */ number | null, /* items_written */ number | null ]
export function utf16ToUtf8(str: number, len: number): [ /* returnType */ string, /* items_read */ number | null, /* items_written */ number | null ]
...
export function utf8GetCharValidated(p: string, max_len: number): number
...
export function utf8Substring(str: string, start_pos: number, end_pos: number): string
export function utf8ToUcs4(str: string, len: number): [ /* returnType */ number, /* items_read */ number | null, /* items_written */ number | null ]
export function utf8ToUcs4Fast(str: string, len: number): [ /* returnType */ number, /* items_written */ number | null ]
export function utf8ToUtf16(str: string, len: number): [ /* returnType */ number, /* items_read */ number | null, /* items_written */ number | null ]
...
export function variantParseErrorPrintContext(error: Error, source_str: string): string
...
export function variantTypeStringGetDepth(type_string: string): number
export function variantTypeStringIsValid(type_string: string): boolean
...
export class AsyncQueue {
    ...
    timedPop(end_time: TimeVal): object | null
    timedPopUnlocked(end_time: TimeVal): object | null
...
export class BookmarkFile {
    ...
    getIcon(uri: string): [ /* returnType */ boolean, /* href */ string | null, /* mime_type */ string | null ]
    ...
    loadFromDataDirs(file: string): [ /* returnType */ boolean, /* full_path */ string | null ]
    loadFromFile(filename: string): boolean
    moveItem(old_uri: string, new_uri?: string | null): boolean
    ...
    setIcon(uri: string, href: string | null, mime_type: string): void
    setIsPrivate(uri: string, is_private: boolean): void
    setMimeType(uri: string, mime_type: string): void
...
export class ByteArray {
    ...
    len:number
    static name: string
    static free(array: any, free_segment: boolean): number
...
export class Checksum {
    ...
    static new(checksum_type: ChecksumType): Checksum
    static typeGetLength(checksum_type: ChecksumType): number
}
export class Cond {
    /* Fields of GLib.Cond */
    ...
    waitUntil(mutex: Mutex, end_time: number): boolean
    static name: string
}
export class Data {
    static name: string
...
export class Date {
    ...
    addDays(n_days: number): void
    addMonths(n_months: number): void
    addYears(n_years: number): void
    ...
    setJulian(julian_date: number): void
    setMonth(month: DateMonth): void
    setParse(str: string): void
    setTime(time_: Time): void
    setTimeT(timet: number): void
    setTimeVal(timeval: TimeVal): void
    setYear(year: DateYear): void
    subtractDays(n_days: number): void
    subtractMonths(n_months: number): void
    subtractYears(n_years: number): void
    ...
    static newJulian(julian_day: number): Date
    ...
    static validJulian(julian_date: number): boolean
...
export class DateTime {
    ...
    addFull(years: number, months: number, days: number, hours: number, minutes: number, seconds: number): DateTime
    ...
    static new(tz: TimeZone, year: number, month: number, day: number, hour: number, minute: number, seconds: number): DateTime
    static newFromIso8601(text: string, default_tz?: TimeZone | null): DateTime | null
...
export class HashTable {
    ...
    static lookupExtended(hash_table: HashTable, lookup_key?: object | null): [ /* returnType */ boolean, /* orig_key */ object | null, /* value */ object | null ]
    static remove(hash_table: HashTable, key?: object | null): boolean
    static removeAll(hash_table: HashTable): void
    ...
    static stealAll(hash_table: HashTable): void
    static stealExtended(hash_table: HashTable, lookup_key?: object | null): [ /* returnType */ boolean, /* stolen_key */ object | null, /* stolen_value */ object | null ]
...
export class Hook {
    ...
    static destroyLink(hook_list: HookList, hook: Hook): void
    static free(hook_list: HookList, hook: Hook): void
    static insertBefore(hook_list: HookList, sibling: Hook | null, hook: Hook): void
...
export class HookList {
    ...
    invokeCheck(may_recurse: boolean): void
    static name: string
}
export class IConv {
...
export class IOChannel {
    ...
    readChars(): [ /* returnType */ IOStatus, /* buf */ any, /* bytes_read */ number | null ]
    readLine(): [ /* returnType */ IOStatus, /* str_return */ string, /* length */ number | null, /* terminator_pos */ number | null ]
    readLineString(buffer: String, terminator_pos?: number | null): IOStatus
    readToEnd(): [ /* returnType */ IOStatus, /* str_return */ any ]
    ...
    setCloseOnUnref(do_close: boolean): void
    setEncoding(encoding?: string | null): IOStatus
    setFlags(flags: IOFlags): IOStatus
    setLineTerm(line_term: string | null, length: number): void
    shutdown(flush: boolean): IOStatus
    unixGetFd(): number
    unref(): void
    write(buf: string, count: number, bytes_written: number): IOError
    writeChars(buf: any, count: number): [ /* returnType */ IOStatus, /* bytes_written */ number ]
...
export class KeyFile {
    ...
    getBoolean(group_name: string, key: string): boolean
    getBooleanList(group_name: string, key: string): boolean[]
    getComment(group_name: string | null, key: string): string
    getDouble(group_name: string, key: string): number
    getDoubleList(group_name: string, key: string): number[]
    getGroups(): [ /* returnType */ string[], /* length */ number | null ]
    getInt64(group_name: string, key: string): number
    getInteger(group_name: string, key: string): number
    getIntegerList(group_name: string, key: string): number[]
    getKeys(group_name: string): [ /* returnType */ string[], /* length */ number | null ]
    getLocaleForKey(group_name: string, key: string, locale?: string | null): string | null
    getLocaleString(group_name: string, key: string, locale?: string | null): string
    getLocaleStringList(group_name: string, key: string, locale?: string | null): string[]
    getStartGroup(): string
    getString(group_name: string, key: string): string
    getStringList(group_name: string, key: string): string[]
    getUint64(group_name: string, key: string): number
    getValue(group_name: string, key: string): string
    hasGroup(group_name: string): boolean
    loadFromBytes(bytes: Bytes, flags: KeyFileFlags): boolean
    loadFromData(data: string, length: number, flags: KeyFileFlags): boolean
    loadFromDataDirs(file: string, flags: KeyFileFlags): [ /* returnType */ boolean, /* full_path */ string | null ]
    loadFromDirs(file: string, search_dirs: string[], flags: KeyFileFlags): [ /* returnType */ boolean, /* full_path */ string | null ]
    loadFromFile(file: string, flags: KeyFileFlags): boolean
    removeComment(group_name?: string | null, key?: string | null): boolean
    removeGroup(group_name: string): boolean
    removeKey(group_name: string, key: string): boolean
    saveToFile(filename: string): boolean
    setBoolean(group_name: string, key: string, value: boolean): void
    setBooleanList(group_name: string, key: string, list: boolean[]): void
    setComment(group_name: string | null, key: string | null, comment: string): boolean
    setDouble(group_name: string, key: string, value: number): void
    setDoubleList(group_name: string, key: string, list: number[]): void
    setInt64(group_name: string, key: string, value: number): void
    setInteger(group_name: string, key: string, value: number): void
    setIntegerList(group_name: string, key: string, list: number[]): void
    setListSeparator(separator: number): void
    setLocaleString(group_name: string, key: string, locale: string, string: string): void
    setLocaleStringList(group_name: string, key: string, locale: string, list: string[]): void
    setString(group_name: string, key: string, string: string): void
    setStringList(group_name: string, key: string, list: string[]): void
    setUint64(group_name: string, key: string, value: number): void
    setValue(group_name: string, key: string, value: string): void
...
export class MainContext {
    ...
    dispatch(): void
    findSourceByFuncsUserData(funcs: SourceFuncs, user_data?: object | null): Source
    findSourceById(source_id: number): Source
    findSourceByUserData(user_data?: object | null): Source
    ...
    static getThreadDefault(): MainContext
...
export class MarkupParseContext {
    ...
    free(): void
    getElement(): string
    getPosition(line_number?: number | null, char_number?: number | null): void
...
export class MatchInfo {
    ...
    expandReferences(string_to_expand: string): string | null
    fetch(match_num: number): string | null
    fetchAll(): string[]
    fetchNamed(name: string): string | null
    fetchNamedPos(name: string): [ /* returnType */ boolean, /* start_pos */ number | null, /* end_pos */ number | null ]
    fetchPos(match_num: number): [ /* returnType */ boolean, /* start_pos */ number | null, /* end_pos */ number | null ]
    free(): void
...
export class OptionContext {
    ...
    addMainEntries(entries: OptionEntry, translation_domain?: string | null): void
    free(): void
    getDescription(): string
    getHelp(main_help: boolean, group?: OptionGroup | null): string
    ...
    parseStrv(arguments_: string[]): boolean
    setDescription(description?: string | null): void
    setHelpEnabled(help_enabled: boolean): void
    setIgnoreUnknownOptions(ignore_unknown: boolean): void
    setMainGroup(group: OptionGroup): void
    setStrictPosix(strict_posix: boolean): void
...
export class Queue {
    ...
    clear(): void
    clearFull(free_func?: DestroyNotify | null): void
    free(): void
    freeFull(free_func: DestroyNotify): void
    getLength(): number
...
export class Rand {
    ...
    setSeedArray(seed: number, seed_length: number): void
    static name: string
}
...
export class Regex {
    ...
    matchAll(string: string, match_options: RegexMatchFlags): [ /* returnType */ boolean, /* match_info */ MatchInfo | null ]
    matchAllFull(string: string[], start_position: number, match_options: RegexMatchFlags): [ /* returnType */ boolean, /* match_info */ MatchInfo | null ]
    matchFull(string: string[], start_position: number, match_options: RegexMatchFlags): [ /* returnType */ boolean, /* match_info */ MatchInfo | null ]
    ref(): Regex
    replace(string: string[], start_position: number, replacement: string, match_options: RegexMatchFlags): string
    replaceLiteral(string: string[], start_position: number, replacement: string, match_options: RegexMatchFlags): string
    split(string: string, match_options: RegexMatchFlags): string[]
    splitFull(string: string[], start_position: number, match_options: RegexMatchFlags, max_tokens: number): string[]
    unref(): void
    static name: string
    ...
    static new(pattern: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): Regex | null
    static checkReplacement(replacement: string): [ /* returnType */ boolean, /* has_references */ boolean | null ]
    static errorQuark(): Quark
    static escapeNul(string: string, length: number): string
    static escapeString(string: string[]): string
    static matchSimple(pattern: string, string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): boolean
    static splitSimple(pattern: string, string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): string[]
}
export class SList {
...
export class Scanner {
    ...
    inputFile(input_fd: number): void
    inputText(text: string, text_len: number): void
    lookupSymbol(symbol: string): object | null
    peekNextToken(): TokenType
    scopeAddSymbol(scope_id: number, symbol: string, value?: object | null): void
    scopeLookupSymbol(scope_id: number, symbol: string): object | null
    scopeRemoveSymbol(scope_id: number, symbol: string): void
    setScope(scope_id: number): number
    syncFileOffset(): void
    unexpToken(expected_token: TokenType, identifier_spec: string, symbol_spec: string, symbol_name: string, message: string, is_error: number): void
    static name: string
}
...
export class Source {
    ...
    addChildSource(child_source: Source): void
    ...
    getTime(): number
    isDestroyed(): boolean
    modifyUnixFd(tag: object, new_events: IOCondition): void
    queryUnixFd(tag: object): IOCondition
    ref(): Source
    removeChildSource(child_source: Source): void
    removePoll(fd: PollFD): void
    removeUnixFd(tag: object): void
    setCallback(func: SourceFunc): void
    setCallbackIndirect(callback_data: object | null, callback_funcs: SourceCallbackFuncs): void
    setCanRecurse(can_recurse: boolean): void
    setFuncs(funcs: SourceFuncs): void
    setName(name: string): void
    setPriority(priority: number): void
    setReadyTime(ready_time: number): void
    unref(): void
    static name: string
    ...
    static removeByFuncsUserData(funcs: SourceFuncs, user_data?: object | null): boolean
    static removeByUserData(user_data?: object | null): boolean
...
export class String {
    ...
    appendUriEscaped(unescaped: string, reserved_chars_allowed: string, allow_utf8: boolean): String
    asciiDown(): String
    asciiUp(): String
...
export class ThreadPool {
    ...
    setMaxThreads(max_threads: number): boolean
    unprocessed(): number
    static name: string
    ...
    static setMaxUnusedThreads(max_threads: number): void
...
export class TimeVal {
    ...
    static name: string
    static fromIso8601(iso_date: string): [ /* returnType */ boolean, /* time_ */ TimeVal ]
}
export class TimeZone {
    /* Methods of GLib.TimeZone */
    adjustTime(type: TimeType, time_: number): number
    findInterval(type: TimeType, time_: number): number
...
export class Tree {
    ...
    lookupExtended(lookup_key?: object | null): [ /* returnType */ boolean, /* orig_key */ object | null, /* value */ object | null ]
    nnodes(): number
...
export class Variant {
    ...
    byteswap(): Variant
    checkFormatString(format_string: string, copy_only: boolean): boolean
    ...
    getChildValue(index_: number): Variant
    getData(): object | null
    ...
    lookupValue(key: string, expected_type?: VariantType | null): Variant
    nChildren(): number
    ...
    unref(): void
    static name: string
    static newArray(child_type: VariantType | null, children: Variant[] | null): Variant
    ...
    static newFixedArray(element_type: VariantType, elements: object | null, n_elements: number, element_size: number): Variant
    static newFromBytes(type: VariantType, bytes: Bytes, trusted: boolean): Variant
    static newFromData(type: VariantType, data: any, trusted: boolean, notify: DestroyNotify, user_data?: object | null): Variant
    ...
    static newMaybe(child_type?: VariantType | null, child?: Variant | null): Variant
    static newObjectPath(object_path: string): Variant
    ...
    static parseErrorPrintContext(error: Error, source_str: string): string
...
export class VariantType {
    ...
    static stringGetDepth(type_string: string): number
    static stringIsValid(type_string: string): boolean
