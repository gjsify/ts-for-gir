...
class Core {
    ...
    on(sigName: "audio-output", callback: (data: any[], sampleRate: number) => void, after?: boolean): NodeJS.EventEmitter
    once(sigName: "audio-output", callback: (data: any[], sampleRate: number) => void, after?: boolean): NodeJS.EventEmitter
    off(sigName: "audio-output", callback: (data: any[], sampleRate: number) => void): NodeJS.EventEmitter
