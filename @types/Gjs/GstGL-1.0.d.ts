...
export class GLContext {
    ...
    static new_wrapped(display: GLDisplay, handle: string, context_type: GLPlatform, available_apis: GLAPI): GLContext
    ...
    static get_current_gl_context(context_type: GLPlatform): string
...
export class GLWindow {
    ...
    vfunc_draw(): void
    vfunc_get_display(): string
    vfunc_get_window_handle(): string
...
export abstract class GLContextClass {
    ...
    get_gl_context: (context: GLContext) => string
...
export abstract class GLDisplayClass {
    ...
    get_handle: (display: GLDisplay) => string
...
export abstract class GLWindowClass {
    ...
    parent_class: Gst.ObjectClass
    get_display: (window: GLWindow) => string
    set_window_handle: (window: GLWindow, handle: string) => void
    get_window_handle: (window: GLWindow) => string
