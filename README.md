...
gjs now supports ES modules, which can be activated with its -m flag. Using this in conjunction with `"module": "es6"` in tsconfig.json is generally more
...
ts-for-gjs. Where you would previosuly write:
