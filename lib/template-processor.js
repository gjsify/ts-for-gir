...
class TemplateProcessor {
    constructor(data, runtime) {
        ...
        this.templateDir = conversations_1.Conversation.getRuntimeDir(runtime, TEMPLATE_DIR);
    }
    /**
    ...
    write(content, targetDir, targetFilename) {
        targetDir = conversations_1.Conversation.getRuntimeDir(this.runtime, targetDir);
