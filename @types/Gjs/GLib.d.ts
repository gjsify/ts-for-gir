...
export function base64_encode(data: Gjs.byteArray.ByteArray | null): string
...
export function utf8_validate_len(str: Gjs.byteArray.ByteArray): [ /* returnType */ boolean, /* end */ string | null ]
...
export class Hmac {
    ...
    get_digest(buffer: Gjs.byteArray.ByteArray): void
    get_string(): string
    unref(): void
    update(data: Gjs.byteArray.ByteArray): void
    static name: string
