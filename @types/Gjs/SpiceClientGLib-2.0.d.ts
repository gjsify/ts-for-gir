...
export abstract class AudioClass {
    ...
    get_playback_volume_info_async: any
    get_playback_volume_info_finish: any
    get_record_volume_info_async: any
    get_record_volume_info_finish: any
    static name: string
}
