...
async function main(): Promise<void> {
  ...
  print(
    `Saved: id=${book1.id}, title="${book1.title}", author="${book1.author}", year=${book1.year}`,
  );
  ...
  print(
    `Saved: id=${book2.id}, title="${book2.title}", author="${book2.author}", year=${book2.year}`,
  );
  ...
  print(
    `Saved: id=${book3.id}, title="${book3.title}", author="${book3.author}", year=${book3.year}`,
  );
