...
function renderModuleMetadata(
  ...
  return JSX.createElement(
    ...
    nsMeta.description &&
      JSX.createElement("p", { class: "gi-docgen-meta-description" }, nsMeta.description),
...
export const giDocgenHeader = (
  ...
  const isModulePage =
    ...
    props.model.kindOf(ReflectionKind.Module) &&
    !props.model.parent?.parent;
  ...
  return JSX.createElement(
    ...
    nsMeta &&
      renderModuleMetadata(
        context,
        nsMeta,
        (props.model as unknown as { packageVersion?: string }).packageVersion ||
          nsMeta.packageVersion,
      ),
  );
};
