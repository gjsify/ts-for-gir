...
export declare namespace DbusmenuGtk3 {
...
export class Menu {
    ...
    connect(sigName: "child-notify", callback: (($obj: Menu, childProperty: GObject.ParamSpec) => void)): number
    connect_after(sigName: "child-notify", callback: (($obj: Menu, childProperty: GObject.ParamSpec) => void)): number
