...
export interface DBusSubtreeDispatchFunc {
    (connection: DBusConnection, sender: string, object_path: string, interface_name: string, node: string, out_user_data: object | null): DBusInterfaceVTable
}
...
export class BufferedInputStream {
    ...
    vfunc_read_async?(buffer: Gjs.byteArray.ByteArray, io_priority: number, cancellable: Cancellable | null, callback: AsyncReadyCallback | null): void
...
export class BufferedOutputStream {
    ...
    vfunc_write_async?(buffer: Gjs.byteArray.ByteArray, io_priority: number, cancellable: Cancellable | null, callback: AsyncReadyCallback | null): void
...
export class Settings {
    ...
    get_mapped(key: string, mapping: SettingsGetMapping): object
...
export class SimpleAsyncResult {
    ...
    static new(source_object: GObject.Object | null, callback: AsyncReadyCallback | null, source_tag: object): SimpleAsyncResult
...
export class Task {
    ...
    static report_error(source_object: GObject.Object | null, callback: AsyncReadyCallback | null, source_tag: object, error: GLib.Error): void
}
