...
export class RemoteRegistry {
    ...
    register_data_source(unique_id: string, name: string, description: string, event_templates: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    ...
    vfunc_register_data_source(unique_id: string, name: string, description: string, event_templates: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
...
export class RemoteLog {
    ...
    delete_events(event_ids: number[], cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    delete_events_finish(_res_: Gio.AsyncResult): GLib.Variant
    find_event_ids(time_range: GLib.Variant, event_templates: GLib.Variant, storage_state: number, num_events: number, result_type: number, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    find_event_ids_finish(_res_: Gio.AsyncResult): number[]
    find_events(time_range: GLib.Variant, event_templates: GLib.Variant, storage_state: number, num_events: number, result_type: number, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    find_events_finish(_res_: Gio.AsyncResult): GLib.Variant
    find_related_uris(time_range: GLib.Variant, event_templates: GLib.Variant, result_event_templates: GLib.Variant, storage_state: number, num_events: number, result_type: number, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    find_related_uris_finish(_res_: Gio.AsyncResult): string[]
    get_events(event_ids: number[], cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    get_events_finish(_res_: Gio.AsyncResult): GLib.Variant
    insert_events(events: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    insert_events_finish(_res_: Gio.AsyncResult): number[]
    install_monitor(monitor_path: any, time_range: GLib.Variant, event_templates: GLib.Variant, owner?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    install_monitor_finish(_res_: Gio.AsyncResult): void
    remove_monitor(monitor_path: any, owner?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    ...
    vfunc_delete_events(event_ids: number[], cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_delete_events_finish(_res_: Gio.AsyncResult): GLib.Variant
    vfunc_find_event_ids(time_range: GLib.Variant, event_templates: GLib.Variant, storage_state: number, num_events: number, result_type: number, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_find_event_ids_finish(_res_: Gio.AsyncResult): number[]
    vfunc_find_events(time_range: GLib.Variant, event_templates: GLib.Variant, storage_state: number, num_events: number, result_type: number, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_find_events_finish(_res_: Gio.AsyncResult): GLib.Variant
    vfunc_find_related_uris(time_range: GLib.Variant, event_templates: GLib.Variant, result_event_templates: GLib.Variant, storage_state: number, num_events: number, result_type: number, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_find_related_uris_finish(_res_: Gio.AsyncResult): string[]
    vfunc_get_events(event_ids: number[], cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_get_events_finish(_res_: Gio.AsyncResult): GLib.Variant
    vfunc_insert_events(events: GLib.Variant, cancellable?: Gio.Cancellable | null, sender?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_insert_events_finish(_res_: Gio.AsyncResult): number[]
    vfunc_install_monitor(monitor_path: any, time_range: GLib.Variant, event_templates: GLib.Variant, owner?: any, _callback_?: Gio.AsyncReadyCallback | null): void
    vfunc_install_monitor_finish(_res_: Gio.AsyncResult): void
    vfunc_remove_monitor(monitor_path: any, owner?: any, _callback_?: Gio.AsyncReadyCallback | null): void
