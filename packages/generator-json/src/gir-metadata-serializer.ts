...
export class GirMetadataSerializer implements SerializerComponent<DeclarationReflection> {
  ...
  private static readonly METADATA_DISPATCH: Array<
    ...
    [
      ...
      (self: GirMetadataSerializer, obj: any) => GirReflectionMetadata,
    ]
  > = [
    ...
    [
      IntrospectedVirtualClassFunction,
      (s, o) => s.buildFunctionLikeMetadata(o, "virtual-method", { isVirtual: true }),
    ],
    [
      IntrospectedStaticClassFunction,
      (s, o) => s.buildFunctionLikeMetadata(o, "static-method", { isStatic: true }),
    ],
  ...
  private extractFunctionParams(
    params: IntrospectedFunctionParameter[],
  ): Partial<GirFunctionMetadata> {
