...
import { APP_NAME, APP_VERSION, type GirModule, Logger, type OptionsGeneration } from "@ts-for-gir/lib";
...
export class BundlePackage {
	...
	async export(): Promise<void> {
		...
		this.log.log(`Bundle ${bundle}: ${namespaceCount} namespaces, ${Object.keys(exports).length} subpaths`);
	}
